  ...
  const newsItems = [
    {
      ...
      shortDescriptionRu: "Кафе снова принимает гостей.",
      shortDescriptionEn: "The cafe is open again.",
      bodyRu: "## Сезон уже открыт",
      bodyEn: "## Season is open",
      images: [DISH_IMAGE],
      startsAt: null,
      endsAt: null,
    ...
    },
    {
      ...
      shortDescriptionRu: "Пряники и медовый торт.",
      shortDescriptionEn: "Gingerbread and honey cake.",
      bodyRu: "**Новые** десерты в меню",
      bodyEn: "**New** desserts on menu",
      images: [DISH_IMAGE],
      startsAt: null,
      endsAt: null,
    ...
    },
    {
      ...
      titleRu: "Вечер D&D",
      titleEn: "D&D Night",
      shortDescriptionRu: "Каждый четверг в Таверне.",
      shortDescriptionEn: "Every Thursday in Tavern.",
      bodyRu: "*Кубики* ждут героев",
      bodyEn: "*Dice* await heroes",
      images: [DISH_IMAGE],
      startsAt: null,
      endsAt: null,
    ...
    },
    {
      ...
      titleEn: "Mead on Tap",
      shortDescriptionRu: "Махакам снова наливают.",
      shortDescriptionEn: "Mahakam is pouring again.",
      bodyRu: "> Налейте медовуху сегодня",
      bodyEn: "> Pour mead today",
      images: [DISH_IMAGE],
      startsAt: null,
      endsAt: null,
    ...
    },
    {
      ...
      shortDescriptionRu: "Карта зала на сайте.",
      shortDescriptionEn: "Hall map on site.",
      bodyRu: "- Забронируйте стол заранее",
      bodyEn: "- Book your table early",
      images: [DISH_IMAGE],
      startsAt: null,
      endsAt: null,
    ...
    },
    {
      ...
      shortDescriptionRu: "Терраса открыта для брони.",
      shortDescriptionEn: "Terrace open for booking.",
      bodyRu: "1. Столы на террасе",
      bodyEn: "1. Terrace tables ready",
      images: [DISH_IMAGE],
      startsAt: null,
      endsAt: null,
    ...
    },
    {
      ...
      shortDescriptionRu: "Скидка на themed-блюда.",
      shortDescriptionEn: "Discount on themed dishes.",
      bodyRu: "**Котёл** ведьмака дешевле",
      bodyEn: "**Cauldron** stew cheaper",
      images: [DISH_IMAGE],
      startsAt: null,
      endsAt: null,
    ...
    },
    {
      ...
      titleRu: "Вечер барда",
      titleEn: "Bard Night",
      shortDescriptionRu: "Баллады в Чертоге.",
      shortDescriptionEn: "Ballads in Great Hall.",
      bodyRu: "## Баллады этим вечером",
      bodyEn: "## Ballads tonight here",
      images: [DISH_IMAGE],
      startsAt: new Date("2026-07-05T20:00:00"),
      endsAt: new Date("2026-07-05T23:00:00"),
    ...
    },
    {
      ...
      shortDescriptionRu: "Folk в Таверне.",
      shortDescriptionEn: "Folk in Tavern.",
      bodyRu: "*Морские* песни и барабаны",
      bodyEn: "*Sea* songs and drums",
      images: [DISH_IMAGE],
    ...
    {
      slug: "akustika-nekromanta",
      type: "PERFORMANCE",
      status: "PUBLISHED",
      titleRu: "Акустика некроманта",
      titleEn: "Necromancer Acoustic",
      shortDescriptionRu: "Тёмный фолк в VIP.",
      shortDescriptionEn: "Dark folk in VIP.",
      bodyRu: "- Тихая музыка сегодня",
      bodyEn: "- Quiet music tonight",
      images: [DISH_IMAGE],
      startsAt: new Date("2026-07-19T20:00:00"),
      endsAt: new Date("2026-07-19T22:00:00"),
    ...
    },
    {
      ...
      shortDescriptionRu: "Живой сет на сцене.",
      shortDescriptionEn: "Live set on stage.",
      bodyRu: "1. Лютик поёт снова",
      bodyEn: "1. Dandelion sings again",
      images: [DISH_IMAGE],
    ...
    },
    {
      ...
      type: "PERFORMANCE",
      status: "PUBLISHED",
      titleRu: "Folk в Чертоге",
      titleEn: "Folk in Great Hall",
      shortDescriptionRu: "Смычковые и лютня.",
      shortDescriptionEn: "Strings and lute.",
      bodyRu: "**Живой** folk вечером",
      bodyEn: "**Live** folk tonight",
      images: [DISH_IMAGE],
      startsAt: new Date("2026-08-02T19:00:00"),
      endsAt: new Date("2026-08-02T22:00:00"),
    ...
    },
    {
      ...
      shortDescriptionRu: "D&D-сессия для команд.",
      shortDescriptionEn: "D&D session for teams.",
      bodyRu: "## Тролль ждёт героев",
      bodyEn: "## Troll awaits heroes",
      images: [DISH_IMAGE],
    ...
    },
    {
      ...
      shortDescriptionRu: "Командный квест в Таверне.",
      shortDescriptionEn: "Team quest in Tavern.",
      bodyRu: "> Берите зеркало смелее",
      bodyEn: "> Bring mirror bravely",
      images: [DISH_IMAGE],
    ...
    },
    {
      ...
      shortDescriptionRu: "Бой для новичков.",
      shortDescriptionEn: "Fight for newcomers.",
      bodyRu: "*Молодой* дракон на арене",
      bodyEn: "*Young* dragon on arena",
      images: [DISH_IMAGE],
